...
RedGL(document.createElement('canvas'), function (v) {
    ...
    redSuite(
        "RedPointBitmapMaterial 테스트",
        redGroup(
            "RedPointBitmapMaterial( redGL )",
            redTest("성공테스트 : 기본 생성 테스트", function (unit, title) {
                try {
                    RedPointBitmapMaterial(tRedGL, tDiffuseTexture);
                    unit.run(true)
                } catch (error) {
                    console.log('///////////////////////////////////////////////////////////')
                    console.log(title, '\n', error)
        ...
        redGroup(
            "(RedPointBitmapMaterial Instance).<b>diffuseTexture</b> = value",
            ...
            redTest("실패테스트  : RedBitmapTexture Instance만 허용", function (unit, title) {
                try {
                    var t0 = RedPointBitmapMaterial(tRedGL, 1);
                    t0.diffuseTexture = null
                } catch (error) {
                    console.log('///////////////////////////////////////////////////////////')
                    console.log(title, '\n', error)
        ...
        redGroup(
            "(RedPointBitmapMaterial Instance).<b>alpha</b> = value",
