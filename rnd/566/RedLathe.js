...
(function () {
    ...
    getPointsOnBezierCurveWithSplitting = function (points, offset, tolerance, newPoints) {
        ...
        if (flatness(points, offset) < tolerance) {
            ...
            var q1 = vec2.lerp([0, 0], p1, p2, t);
            var q2 = vec2.lerp([0, 0], p2, p3, t);
            var q3 = vec2.lerp([0, 0], p3, p4, t);

            var r1 = vec2.lerp([0, 0], q1, q2, t);
            var r2 = vec2.lerp([0, 0], q2, q3, t);

            var red = vec2.lerp([0, 0], r1, r2, t);
    ...
    /**DOC:
     ...
     :DOC*/
    RedLathe = function (redGL, svgStr, numDivisions, capStart, capEnd, startAngle, endAngle, maxAngle, distance, tolerance, flipX, flipY) {
        if (!(this instanceof RedLathe)) return new RedLathe(redGL, svgStr, numDivisions, capStart, capEnd, startAngle, endAngle, maxAngle, distance, tolerance, flipX, flipY);
        ...
        tType = 'RedLathe' + '_' + svgStr + '_' + numDivisions + '_' + capStart + '_' + capEnd + '_' + startAngle + '_' + endAngle + '_' + maxAngle + '_' + distance + '_' + tolerance + '_' + flipX + '_' + flipY;
        // 유일키 방어
        ...
        //
        tPrimitiveData = makeData(redGL, tType, finalData, numDivisions, capStart, capEnd, startAngle, endAngle);
