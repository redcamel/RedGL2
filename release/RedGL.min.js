...
*/},(RedPostEffect_BloomThreshold=function(r){if(!(this instanceof RedPostEffect_BloomThreshold))return new RedPostEffect_BloomThreshold(r);var n;r instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_BloomThreshold : RedGL Instance만 허용됩니다.",r),this.frameBuffer=RedFrameBuffer(r),this.diffuseTexture=null,this._threshold=null,Object.defineProperty(this,"threshold",(n=128,{get:function(){return n},set:function(e){"number"!=typeof e&&RedGLUtil.throwFunc("RedPostEffect_BloomThreshold : threshold 숫자만허용함","입력값 : "+e),(n=e)<1&&(n=1),n>255&&(n=255),this._threshold=n/255}})),this.threshold=128,this.program=RedProgram.makeProgram(r,"RedPostEffect_BloomThreshold_Program",e,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkUniformAndProperty()}).prototype=new RedBaseMaterial,Object.freeze(RedPostEffect_BloomThreshold)}(),function(){var e,t;e=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
...
*/},(RedPostEffect_FXAA=function(r){if(!(this instanceof RedPostEffect_FXAA))return new RedPostEffect_FXAA(r);r instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_FXAA : RedGL Instance만 허용됩니다.",r),this.frameBuffer=RedFrameBuffer(r),this.diffuseTexture=null,this.program=RedProgram.makeProgram(r,"RedPostEffect_FXAA_Program",e,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkUniformAndProperty()}).prototype=new RedBaseMaterial,Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-06-05 20:53:13)');