    ...
    makeProgram = (function () {
        ...
        fSource = function () {
            ...
            void main() {
                ...
                // add noise
                vec3 cResult = finalColor.rgb + finalColor.rgb * clamp( 0.1 + dx * 100.0, 0.0, 1.0 );
                
                // get us a sine and cosine
                vec2 sc = vec2( sin( vTexcoord.y * uScanlineCount ), cos( vTexcoord.y * uScanlineCount ) );
               
                // add scanlines
                cResult += finalColor.rgb * vec3( sc.x, sc.y, sc.x ) * uScanlineIntensity;
               
                // interpolate between source and result by intensity
                cResult = finalColor.rgb + clamp( uNoiseIntensity, 0.0, 1.0 ) * ( cResult - finalColor.rgb );
               
                // convert to grayscale if desired
                if( uGray ) cResult = vec3( cResult.r * 0.3 + cResult.g * 0.59 + cResult.b * 0.11 );
                gl_FragColor =  vec4( cResult, finalColor.a );
            }
            */
        }
        vSource = RedGLUtil.getStrFromComment(vSource.toString());
...
})();console.log('RedGL Release. last update(2018-05-03 17:33:58)');