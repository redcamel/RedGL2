...
*/},(RedBitmapMaterial=function(r,n){if(!(this instanceof RedBitmapMaterial))return new RedBitmapMaterial(r,n);r instanceof RedGL||RedGLUtil.throwFunc("RedBitmapMaterial : RedGL Instance만 허용됩니다.",r),this.diffuseTexture=n,this.program=RedProgram.makeProgram(r,"RedBitmapMaterial_Program",e,t),this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()}).prototype=new RedBaseMaterial,RedDefinePropertyInfo.definePrototype("RedBitmapMaterial","diffuseTexture","sampler2D",{essential:!0}),Object.freeze(RedBitmapMaterial)}(),function(){var e,t;e=function(){
/* @preserve
varying vec4 vColor;
void main(void) {
vColor = aVertexColor;
...
*/},(RedPostEffect_FXAA=function(r){if(!(this instanceof RedPostEffect_FXAA))return new RedPostEffect_FXAA(r);r instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_FXAA : RedGL Instance만 허용됩니다.",r),this.frameBuffer=RedFrameBuffer(r),this.diffuseTexture=null,this.program=RedProgram.makeProgram(r,"RedPostEffect_FXAA_Program",e,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.checkUniformAndProperty()}).prototype=new RedBaseMaterial,RedPostEffect_FXAA.prototype.bind=RedPostEffectManager.prototype.bind,RedPostEffect_FXAA.prototype.unbind=RedPostEffectManager.prototype.unbind,Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-07-05 21:01:08)');