...
*/},(RedPostEffect_FXAA=function(n){if(!(this instanceof RedPostEffect_FXAA))return new RedPostEffect_FXAA(n);n instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_FXAA : RedGL Instance만 허용.",n),this.frameBuffer=RedFrameBuffer(n),this.diffuseTexture=null,this.program=RedProgram.makeProgram(n,"RedPostEffectFXAAProgram",e,t),this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBasePostEffect,RedPostEffect_FXAA.prototype.updateTexture=function(e){this.diffuseTexture=e},RedDefinePropertyInfo.definePrototype("RedPostEffect_FXAA","diffuseTexture","sampler2D"),Object.freeze(RedPostEffect_FXAA)}(),function(){var e,t,r,n,i,a,o;(RedGLOffScreen=function(e,t,r,n,i){if(!(this instanceof RedGLOffScreen))return new RedGLOffScreen(e,t,r,n,i);t=parseInt(t),r=parseInt(r);var a=this;a.htmlCanvas=e,a.redGLSrc=n,fetch(i).then(function(e){e.text().then(function(e){a.hostCode="\ncanvas.tagName = 'CANVAS';\nreturn RedGL(canvas, function (v) {\nvar _host_ = "+e+";\n_host_.call(this);\n\n});",a.setSize(t,r)})}).catch(function(e){})}).prototype.updatePostMessage=function(e){if(!e)throw"RedGLOffScreen.prototype['updatePostMessage'] - run을 정의해야합니다."+e;if(!e.name)throw"RedGLOffScreen.prototype['updatePostMessage'] - run객체의 name을 정의해야합니다."+e.name;this.worker.postMessage({state:"update",run:e})},RedGLOffScreen.prototype._init=function(r,n,i){var a=this;this.worker&&this.worker.terminate();var o=this.htmlCanvas.parentNode,s=r.cloneNode(!0);o.replaceChild(s,this.htmlCanvas),this.htmlCanvas=s;var d="x,y,clientX,clientY,pageX,pageY,screenX,screenY,layerX,layerY,detail,shiftKey,altKey,ctrlKey,movementX,movementY,button,type,which,deltaX,deltaY,deltaZ,timeStamp".split(","),f="shiftKey,altKey,ctrlKey,key,keyCode,location,code,charCode,detail,timeStamp,which,type".split(","),c="mousemove,mousedown,mouseup,wheel".split(","),u="keydown,keyup,keypress".split(",");c.forEach(function(e){a.htmlCanvas.addEventListener(e,function(e){var t={};d.forEach(function(r){t[r]=e[r]}),a.worker.postMessage({state:e.type,event:t})})}),u.forEach(function(e){window.addEventListener(e,function(e){var t={};f.forEach(function(r){t[r]=e[r]}),a.worker.postMessage({state:e.type,event:t})})}),this.offScreenCanvas=this.htmlCanvas.transferControlToOffscreen(),this.offScreenCanvas.width=n,this.offScreenCanvas.height=i,this.worker=null,t=new Blob([e],{type:"application/javascript"}),this.worker=new Worker(URL.createObjectURL(t));var l=document.location.pathname.split("/");l[l.length-1].indexOf(".")>-1&&l.pop();var h=this.redGLSrc.split("/");h.forEach(function(e,t){".."===e&&(l.pop(),h[t]=""),"."===e&&(h[t]="")}),this.worker.postMessage({canvas:this.offScreenCanvas,state:"init",redGLSrc:document.location.origin+l.join("/")+"/"+h.join("/"),hostCode:this.hostCode.toString()},[this.offScreenCanvas])},RedGLOffScreen.prototype.setSize=(i=0,a=0,function(e,t,s){void 0===e&&RedGLUtil.throwFunc("RedGL setSize : width가 입력되지 않았습니다."),void 0===t&&RedGLUtil.throwFunc("RedGL setSize : height가 입력되지 않았습니다."),r=this._width=e,n=this._height=t,"number"!=typeof r&&(r.indexOf("%")>-1?r=(document.documentElement?document.documentElement.clientWidth:document.body.clientWidth)*parseFloat(r)/100:RedGLUtil.throwFunc("RedGL setSize : width는 0이상의 숫자나 %만 허용.",r)),"number"!=typeof n&&(n.indexOf("%")>-1?n=window.innerHeight*parseFloat(n)/100:RedGLUtil.throwFunc("RedGL setSize : height는 0이상의 숫자나 %만 허용.",n)),o=window.devicePixelRatio||1,this._canvas,(i!==r||a!==n||s)&&(i=r,a=n),this._init(this.htmlCanvas,r*o,n*o)}),e=(e=function(){var e,t;this.window=this,onmessage=function(r){switch(r.data.state){case"init":e||(importScripts(r.data.redGLSrc),e=new Function("canvas",r.data.hostCode)),t=new e(r.data.canvas);break;case"update":var n=r.data.run.args;t.userInterface[r.data.run.name]["array"==typeof n?"apply":"call"](t,r.data.run.args);break;case"mousemove":var i=new Event("mousemove"),a=r.data.event;for(var o in a)i[o]=a[o];t._canvas.dispatchEvent(i);break;case"mousedown":for(var o in i=new Event("mousedown"),a=r.data.event)i[o]=a[o];t._canvas.dispatchEvent(i);break;case"mouseup":for(var o in i=new Event("mouseup"),a=r.data.event)i[o]=a[o];this.window.dispatchEvent(i);break;case"wheel":for(var o in i=new Event("wheel"),a=r.data.event)i[o]=a[o];t._canvas.dispatchEvent(i);break;case"keydown":for(var o in i=new Event("keydown"),a=r.data.event)i[o]=a[o];this.window.dispatchEvent(i);break;case"keyup":for(var o in i=new Event("keyup"),a=r.data.event)i[o]=a[o];this.window.dispatchEvent(i);break;case"keypress":for(var o in i=new Event("keypress"),a=r.data.event)i[o]=a[o];this.window.dispatchEvent(i)}}}).toString().replace(/^function ?. ?\) ?\{|\}\;?$/g,"")}();console.log('RedGL Release. last update(2018-10-04 15:32:29)');