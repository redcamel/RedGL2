...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"testrProgram",t,r)},RedMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedMaterial)}(),function(){var e,t,r,n;RedColorMaterial=function(t,r,n){if(!(this instanceof RedColorMaterial))return new RedColorMaterial(t,r,n);this.color=new Float32Array(4),this.setColor(r||"#ff0000",void 0==n?1:n),this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"colorProgram",t,r)},RedColorMaterial.prototype=RedBaseMaterial.prototype,RedColorMaterial.prototype.setColor=function(e,t){e=e||"#ff2211",void 0==t&&(t=1),t>1&&(t=1),n=RedGLUtil.hexToRGB.call(this,e),this.color[0]=n[0],this.color[1]=n[1],this.color[2]=n[2],this.color[3]=t},Object.freeze(RedColorMaterial)}(),function(){var e,t,r;RedColorPhongMaterial=function(t,r,n){if(!(this instanceof RedColorPhongMaterial))return new RedColorPhongMaterial(t,r,n);this.color=new Float32Array(4),this.shininess=16,this.specularPower=1,this.setColor(r||"#ff0000",void 0==n?1:n),this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
uniform vec4 uColor;
varying vec4 vColor;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"colorPhongTextureProgram",t,r)},RedColorPhongTextureMaterial.prototype=RedBaseMaterial.prototype,RedColorPhongTextureMaterial.prototype.setColor=RedColorMaterial.prototype.setColor,Object.freeze(RedColorPhongTextureMaterial)}(),function(){var e,t,r;RedEnvironmentMaterial=function(t,r,n,i,a,o){if(!(this instanceof RedEnvironmentMaterial))return new RedEnvironmentMaterial(t,r,n,i,a,o);t instanceof RedGL||RedGLUtil.throwFunc("RedEnvironmentMaterial : RedGL Instance만 허용됩니다.",t),r instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : diffuseTexture - RedBitmapTexture Instance만 허용됩니다."),!n||n instanceof RedBitmapCubeTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : environmentTexture - RedBitmapCubeTexture Instance만 허용됩니다."),!i||i instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : normalTexture - RedBitmapTexture Instance만 허용됩니다."),!a||a instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : specularTexture - RedBitmapTexture Instance만 허용됩니다."),!o||o instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : displacementTexture - RedBitmapTexture Instance만 허용됩니다."),this.diffuseTexture=r,this.environmentTexture=n,this.normalTexture=i,this.specularTexture=a,this.displacementTexture=o,this.shininess=8,this.specularPower=1,this.reflectionPower=1,this.displacementPower=0,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
varying vec4 vVertexPositionEye4;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"environmentProgram",t,r)},RedEnvironmentMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedEnvironmentMaterial)}(),function(){var e,t,r;RedBitmapMaterial=function(t,r){if(!(this instanceof RedBitmapMaterial))return new RedBitmapMaterial(t,r);t instanceof RedGL||RedGLUtil.throwFunc("RedBitmapMaterial : RedGL Instance만 허용됩니다.",t),r instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedBitmapMaterial : RedBitmapTexture Instance만 허용됩니다."),this.diffuseTexture=r,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
mat4 calSprite3D(mat4 cameraMTX, mat4 mvMatrix){
mat4 cacheScale = mat4(
mvMatrix[0][0], 0.0, 0.0, 0.0,
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"bitmapProgram",t,r)},RedBitmapMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedBitmapMaterial)}(),function(){var e,t,r;RedPointBitmapMaterial=function(t,r){if(!(this instanceof RedPointBitmapMaterial))return new RedPointBitmapMaterial(t,r);t instanceof RedGL||RedGLUtil.throwFunc("RedPointBitmapMaterial : RedGL Instance만 허용됩니다.",t),r instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedPointBitmapMaterial : RedBitmapTexture Instance만 허용됩니다."),this.diffuseTexture=r,this.program=e(this,t),this.alphaTest=1e-5,this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
void main(void) {
gl_PointSize = aPointSize;
gl_Position = uPMatrix * uCameraMatrix* uMMatrix * vec4(aVertexPosition, 1.0);
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"pointBitmapProgram",t,r)},RedPointBitmapMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedPointBitmapMaterial)}(),function(){var e,t,r;RedStandardMaterial=function(t,r,n,i,a){if(!(this instanceof RedStandardMaterial))return new RedStandardMaterial(t,r,n,i,a);t instanceof RedGL||RedGLUtil.throwFunc("RedStandardMaterial : RedGL Instance만 허용됩니다.",t),r instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedStandardMaterial : diffuseTexture - RedBitmapTexture Instance만 허용됩니다."),!n||n instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedStandardMaterial : normalTexture - RedBitmapTexture Instance만 허용됩니다."),!i||i instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedStandardMaterial : specularTexture - RedBitmapTexture Instance만 허용됩니다."),!a||a instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedStandardMaterial : displacementTexture - RedBitmapTexture Instance만 허용됩니다."),this.diffuseTexture=r,this.normalTexture=n,this.specularTexture=i,this.displacementTexture=a,this.shininess=16,this.specularPower=1,this.displacementPower=0,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
uniform sampler2D uDisplacementTexture;
uniform float uDisplacementPower;
varying vec4 vVertexPositionEye4;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"standardProgram",t,r)},RedStandardMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedStandardMaterial)}(),function(){var e,t,r;RedGridMaterial=function(t){if(!(this instanceof RedGridMaterial))return new RedGridMaterial(t);this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.checkProperty(),Object.seal(this)},t=function(){
/* @preserve
varying vec4 vColor;
void main(void) {
vColor = aVertexColor;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"gridMaterialProgram",t,r)},RedGridMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedGridMaterial)}(),function(){var e,t,r;RedPointColorMaterial=function(t){if(!(this instanceof RedPointColorMaterial))return new RedPointColorMaterial(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPointColorMaterial : RedGL Instance만 허용됩니다.",t),this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
varying vec4 vColor;
void main(void) {
gl_PointSize = aPointSize;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"skyboxProgram",t,r)},RedSkyBoxMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedSkyBoxMaterial)}(),function(){var e,t,r;RedPostEffectMaterial=function(t,r){if(!(this instanceof RedPostEffectMaterial))return new RedPostEffectMaterial(t,r);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffectMaterial : RedGL Instance만 허용됩니다.",t),r instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedPostEffectMaterial : RedBitmapTexture Instance만 허용됩니다."),this.diffuseTexture=r,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
gl_Position = uPMatrix * uCameraMatrix * uMMatrix *  vec4(aVertexPosition, 1.0);
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_Bloom_Program",t,r)},RedPostEffect_Bloom.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_Bloom)}(),function(){var e,t,r;RedPostEffect_BloomThreshold=function(t){if(!(this instanceof RedPostEffect_BloomThreshold))return new RedPostEffect_BloomThreshold(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_BloomThreshold : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.threshold=.24,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
gl_Position = uPMatrix * uMMatrix *  vec4(aVertexPosition, 1.0);
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_Blur_Program",t,r)},RedPostEffect_Blur.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_Blur)}(),function(){var e,t,r;RedPostEffect_BlurX=function(t){if(!(this instanceof RedPostEffect_BlurX))return new RedPostEffect_BlurX(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_BlurX : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.size=50,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
vResolution = uResolution;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_DoF_Program",t,r)},RedPostEffect_DoF.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_DoF)}(),function(){var e,t,r;RedPostEffect_DoF_DepthMaterial=function(t){if(!(this instanceof RedPostEffect_DoF_DepthMaterial))return new RedPostEffect_DoF_DepthMaterial(t);this.focusLength=15,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
mat4 calSprite3D(mat4 cameraMTX, mat4 mvMatrix){
mat4 cacheScale = mat4(
mvMatrix[0][0], 0.0, 0.0, 0.0,
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_DoF_depthProgram",t,r)},RedPostEffect_DoF_DepthMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_DoF_DepthMaterial)}(),function(){var e,t,r;RedPostEffect_Film=function(t,r,n){if(!(this instanceof RedPostEffect_Film))return new RedPostEffect_Film(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_Film : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.grayMode=!1,this.scanlineIntensity=.5,this.noiseIntensity=.5,this.scanlineCount=2048,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
vTime = uTime;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_Gray_Program",t,r)},RedPostEffect_Gray.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_Gray)}(),function(){var e,t,r;RedPostEffect_HalfTone=function(t){if(!(this instanceof RedPostEffect_HalfTone))return new RedPostEffect_HalfTone(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_HalfTone : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.centerX=0,this.centerY=0,this.angle=0,this.radius=2,this.grayMode=!1,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
vResolution = uResolution;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_HalfTone_Program",t,r)},RedPostEffect_HalfTone.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_HalfTone)}(),function(){var e,t,r;RedPostEffect_HueSaturation=function(t){if(!(this instanceof RedPostEffect_HueSaturation))return new RedPostEffect_HueSaturation(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_HueSaturation : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.hue=0,this.saturation=0,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
gl_Position = uPMatrix * uMMatrix *  vec4(aVertexPosition, 1.0);
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_HueSaturation_Program",t,r)},RedPostEffect_HueSaturation.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_HueSaturation)}(),function(){var e,t,r;RedPostEffect_Invert=function(t){if(!(this instanceof RedPostEffect_Invert))return new RedPostEffect_Invert(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_Invert : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
gl_Position = uPMatrix * uMMatrix *  vec4(aVertexPosition, 1.0);
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_Invert_Program",t,r)},RedPostEffect_Invert.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_Invert)}(),function(){var e,t,r;RedPostEffect_Pixelize=function(t){if(!(this instanceof RedPostEffect_Pixelize))return new RedPostEffect_Pixelize(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_Pixelize : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.width=5,this.height=5,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
vResolution = uResolution;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_Pixelize_Program",t,r)},RedPostEffect_Pixelize.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_Pixelize)}(),function(){var e,t,r;RedPostEffect_Threshold=function(t){if(!(this instanceof RedPostEffect_Threshold))return new RedPostEffect_Threshold(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_Threshold : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.threshold=.24,this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
gl_Position = uPMatrix * uMMatrix *  vec4(aVertexPosition, 1.0);
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_Threshold_Program",t,r)},RedPostEffect_Threshold.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_Threshold)}(),function(){var e,t,r;RedPostEffect_Vignetting=function(t){if(!(this instanceof RedPostEffect_Vignetting))return new RedPostEffect_Vignetting(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_Vignetting : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.size=.1,this.indensity=.85,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
gl_Position = uPMatrix * uMMatrix *  vec4(aVertexPosition, 1.0);
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_Vignetting_Program",t,r)},RedPostEffect_Vignetting.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_Vignetting)}(),function(){var e,t,r;RedPostEffect_ZoomBlur=function(t){if(!(this instanceof RedPostEffect_ZoomBlur))return new RedPostEffect_ZoomBlur(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_ZoomBlur : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.centerX=0,this.centerY=0,this.strength=.15,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
gl_Position = uPMatrix * uMMatrix *  vec4(aVertexPosition, 1.0);
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_ZoomBlur_Program",t,r)},RedPostEffect_ZoomBlur.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_ZoomBlur)}(),function(){var e,t,r;RedPostEffect_FXAA=function(t){if(!(this instanceof RedPostEffect_FXAA))return new RedPostEffect_FXAA(t);t instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_FXAA : RedGL Instance만 허용됩니다.",t),this.frameBuffer=RedFrameBuffer(t),this.diffuseTexture=null,this.program=e(this,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.bind=RedPostEffectManager.prototype.bind,this.unbind=RedPostEffectManager.prototype.unbind,this.checkProperty()},t=function(){
/* @preserve
void main(void) {
vTexcoord = uAtlascoord.xy + aTexcoord * uAtlascoord.zw;
vResolution = uResolution;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e,n){return e.checkProgram(n,"RedPostEffect_FXAA_Program",t,r)},RedPostEffect_FXAA.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-05-31 11:08:00)');