...
*/},(RedParticleBitmapMaterial=function(n,i){if(!(this instanceof RedParticleBitmapMaterial))return new RedParticleBitmapMaterial(n,i);n instanceof RedGL||RedGLUtil.throwFunc("RedParticleBitmapMaterial : RedGL Instance만 허용.",n),this.makeProgramList(this,n,"particleBitmapProgram",e,t),this.diffuseTexture=i,this.alpha=1,this.cutOff=0,this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBaseMaterial,RedDefinePropertyInfo.definePrototype("RedParticleBitmapMaterial","diffuseTexture","sampler2D",{essential:!0}),RedDefinePropertyInfo.definePrototype("RedParticleBitmapMaterial","alpha","number",{min:0,max:1}),RedDefinePropertyInfo.definePrototype("RedParticleBitmapMaterial","cutOff","number",{min:0,max:1}),Object.freeze(RedParticleBitmapMaterial)}(),function(){var e,t,r,n=[];e=function(){
/* @preserve
void main(void) {
gl_Position = uPMatrix * uCameraMatrix* uMMatrix * vec4(aVertexPosition, 1.0);
gl_PointSize = aPointSize/gl_Position.w * uResolution.y;
