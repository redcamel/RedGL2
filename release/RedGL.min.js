...
*/},(RedPostEffect_Bloom=function(n){if(!(this instanceof RedPostEffect_Bloom))return new RedPostEffect_Bloom(n);n instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_Bloom : RedGL Instance만 허용됩니다.",n),this.frameBuffer=RedFrameBuffer(n),this.diffuseTexture=null,this.blurTexture=null,this.exposure=1,this.bloomStrength=1.2,this.process=[RedPostEffect_BloomThreshold(n),RedPostEffect_BlurX(n),RedPostEffect_BlurY(n)],this.blur=20,this.threshold=75,this.program=RedProgram.makeProgram(n,"RedPostEffectBloomProgram",e,t),this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBasePostEffect,RedPostEffect_Bloom.prototype.updateTexture=function(e,t){this.diffuseTexture=t,this.blurTexture=e},RedDefinePropertyInfo.definePrototype("RedPostEffect_Bloom","diffuseTexture","sampler2D"),RedDefinePropertyInfo.definePrototype("RedPostEffect_Bloom","blurTexture","sampler2D"),RedDefinePropertyInfo.definePrototype("RedPostEffect_Bloom","exposure","number",{min:0}),RedDefinePropertyInfo.definePrototype("RedPostEffect_Bloom","bloomStrength","number",{min:0}),RedDefinePropertyInfo.definePrototype("RedPostEffect_Bloom","threshold","number",{min:0,callback:function(e){this.process[0].threshold=e,this._threshold=this.process[0].threshold}}),RedDefinePropertyInfo.definePrototype("RedPostEffect_Bloom","blur","number",{min:0,callback:function(e){this.process[1].size=e,this.process[2].size=e}}),Object.freeze(RedPostEffect_Bloom)}(),function(){var e,t,r;e=function(){
/* @preserve
void main(void) {
vTexcoord = aTexcoord;
gl_Position = uPMatrix * uMMatrix *  vec4(aVertexPosition, 1.0);
...
*/},(RedPostEffect_DoF=function(n){if(!(this instanceof RedPostEffect_DoF))return new RedPostEffect_DoF(n);n instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_DoF : RedGL Instance만 허용됩니다.",n),this.frameBuffer=RedFrameBuffer(n),this.diffuseTexture=null,this.blurTexture=null,this.depthTexture=null,this.subFrameBufferList=[{frameBuffer:RedFrameBuffer(n),renderMaterial:RedPostEffect_DoF_DepthMaterial(n),process:[]}],this.process=[RedPostEffect_BlurX(n),RedPostEffect_BlurY(n)],this.focusLength=15,this.blur=10,this.program=RedProgram.makeProgram(n,"RedPostEffectDoFProgram",e,t),this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBasePostEffect,RedPostEffect_DoF.prototype.updateTexture=function(e,t){this.diffuseTexture=t,this.blurTexture=e,this.depthTexture=this.subFrameBufferList[0].frameBuffer.texture},RedDefinePropertyInfo.definePrototype("RedPostEffect_DoF","diffuseTexture","sampler2D"),RedDefinePropertyInfo.definePrototype("RedPostEffect_DoF","blurTexture","sampler2D"),RedDefinePropertyInfo.definePrototype("RedPostEffect_DoF","depthTexture","sampler2D"),RedDefinePropertyInfo.definePrototype("RedPostEffect_DoF","blur","number",{min:0,callback:function(e){this.process[0].size=e,this.process[1].size=e}}),Object.defineProperty(RedPostEffect_DoF.prototype,"focusLength",{get:function(){return this.subFrameBufferList[0].renderMaterial.focusLength},set:function(e){this.subFrameBufferList[0].renderMaterial.focusLength=e}}),Object.freeze(RedPostEffect_DoF)}(),function(){var e,t,r;e=function(){
/* @preserve
mat4 calSprite3D(mat4 cameraMTX, mat4 mvMatrix){
mat4 cacheScale = mat4(
mvMatrix[0][0], 0.0, 0.0, 0.0,
...
*/},(RedPostEffect_FXAA=function(n){if(!(this instanceof RedPostEffect_FXAA))return new RedPostEffect_FXAA(n);n instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_FXAA : RedGL Instance만 허용됩니다.",n),this.frameBuffer=RedFrameBuffer(n),this.diffuseTexture=null,this.program=RedProgram.makeProgram(n,"RedPostEffectFXAAProgram",e,t),this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBasePostEffect,RedPostEffect_FXAA.prototype.updateTexture=function(e){this.diffuseTexture=e},RedDefinePropertyInfo.definePrototype("RedPostEffect_FXAA","diffuseTexture","sampler2D"),Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-07-31 12:42:02)');