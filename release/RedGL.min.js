...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"testrProgram",t,r)},RedMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedMaterial)}(),function(){var e,t,r,n;RedColorMaterial=function(t,r,n){if(!(this instanceof RedColorMaterial))return new RedColorMaterial(t,r,n);this.color=new Float32Array(4),this.setColor(r||"#ff0000",void 0==n?1:n),this.program=e(t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"RedPostEffect_FXAA_Program",t,r)},RedPostEffect_FXAA.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-05-31 16:40:44)');