...
*/},(RedVideoMaterial=function(r,n){if(!(this instanceof RedVideoMaterial))return new RedVideoMaterial(r,n);r instanceof RedGL||RedGLUtil.throwFunc("RedVideoMaterial : RedGL Instance만 허용됩니다.",r),this._videoTexture=n,this.program=RedProgram.makeProgram(r,"videoProgram",e,t),this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()}).prototype=RedBaseMaterial.prototype,Object.freeze(RedVideoMaterial)}(),function(){var e,t;e=function(){
/* @preserve
varying vec4 vColor;
void main(void) {
vColor = aVertexColor;
