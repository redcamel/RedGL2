...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"colorProgram",t,r)},RedColorMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedColorMaterial)}(),function(){var e,t,r;RedColorPhongMaterial=function(t,r,n){if(!(this instanceof RedColorPhongMaterial))return new RedColorPhongMaterial(t,r,n);this._color=new Float32Array(4),this.shininess=16,this.specularPower=1,Object.defineProperty(this,"color",RedDefinePropertyInfo.color),Object.defineProperty(this,"alpha",RedDefinePropertyInfo.alpha),this.alpha=void 0==n?1:n,this.color=r||"#ff0000",this.program=e(t),this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()},t=function(){
/* @preserve
uniform vec4 u_color;
varying vec4 vColor;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"colorPhongProgram",t,r)},RedColorPhongMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedColorPhongMaterial)}(),function(){var e,t,r;RedColorPhongTextureMaterial=function(t,r,n,i,a,o){if(!(this instanceof RedColorPhongTextureMaterial))return new RedColorPhongTextureMaterial(t,r,n,i,a,o);this._color=new Float32Array(4),this.normalTexture=i,this.specularTexture=a,this.displacementTexture=o,this.shininess=16,this.specularPower=1,this.displacementPower=0,Object.defineProperty(this,"color",RedDefinePropertyInfo.color),Object.defineProperty(this,"alpha",RedDefinePropertyInfo.alpha),this.alpha=void 0==n?1:n,this.color=r||"#ff0000",this.program=e(t),this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()},t=function(){
/* @preserve
uniform vec4 u_color;
varying vec4 vColor;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"colorPhongTextureProgram",t,r)},RedColorPhongTextureMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedColorPhongTextureMaterial)}(),function(){var e,t,r;RedEnvironmentMaterial=function(t,r,n,i,a,o){if(!(this instanceof RedEnvironmentMaterial))return new RedEnvironmentMaterial(t,r,n,i,a,o);t instanceof RedGL||RedGLUtil.throwFunc("RedEnvironmentMaterial : RedGL Instance만 허용됩니다.",t),r instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : diffuseTexture - RedBitmapTexture Instance만 허용됩니다."),!n||n instanceof RedBitmapCubeTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : environmentTexture - RedBitmapCubeTexture Instance만 허용됩니다."),!i||i instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : normalTexture - RedBitmapTexture Instance만 허용됩니다."),!a||a instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : specularTexture - RedBitmapTexture Instance만 허용됩니다."),!o||o instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedEnvironmentMaterial : displacementTexture - RedBitmapTexture Instance만 허용됩니다."),this.diffuseTexture=r,this.environmentTexture=n,this.normalTexture=i,this.specularTexture=a,this.displacementTexture=o,this.shininess=8,this.specularPower=1,this.reflectionPower=1,this.displacementPower=0,this.program=e(t),this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()},t=function(){
/* @preserve
varying vec4 vVertexPositionEye4;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"bitmapProgram",t,r)},RedBitmapMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedBitmapMaterial)}(),function(){var e,t,r;RedPointBitmapMaterial=function(t,r){if(!(this instanceof RedPointBitmapMaterial))return new RedPointBitmapMaterial(t,r);t instanceof RedGL||RedGLUtil.throwFunc("RedPointBitmapMaterial : RedGL Instance만 허용됩니다.",t),r instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedPointBitmapMaterial : RedBitmapTexture Instance만 허용됩니다."),this.diffuseTexture=r,this.program=e(t),this.alphaTest=1e-5,this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()},t=function(){
/* @preserve
void main(void) {
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"pointBitmapProgram",t,r)},RedPointBitmapMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedPointBitmapMaterial)}(),function(){var e,t,r;RedStandardMaterial=function(t,r,n,i,a){if(!(this instanceof RedStandardMaterial))return new RedStandardMaterial(t,r,n,i,a);t instanceof RedGL||RedGLUtil.throwFunc("RedStandardMaterial : RedGL Instance만 허용됩니다.",t),r instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedStandardMaterial : diffuseTexture - RedBitmapTexture Instance만 허용됩니다."),!n||n instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedStandardMaterial : normalTexture - RedBitmapTexture Instance만 허용됩니다."),!i||i instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedStandardMaterial : specularTexture - RedBitmapTexture Instance만 허용됩니다."),!a||a instanceof RedBitmapTexture||RedGLUtil.throwFunc("RedStandardMaterial : displacementTexture - RedBitmapTexture Instance만 허용됩니다."),this.diffuseTexture=r,this.normalTexture=n,this.specularTexture=i,this.displacementTexture=a,this.shininess=16,this.specularPower=1,this.displacementPower=0,this.program=e(t),this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()},t=function(){
/* @preserve
uniform sampler2D uDisplacementTexture;
uniform float uDisplacementPower;
varying vec4 vVertexPositionEye4;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"RedPostEffect_DoF_Program",t,r)},RedPostEffect_DoF.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_DoF)}(),function(){var e,t,r;RedPostEffect_DoF_DepthMaterial=function(t){if(!(this instanceof RedPostEffect_DoF_DepthMaterial))return new RedPostEffect_DoF_DepthMaterial(t);this.focusLength=15,this.program=e(t),this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()},t=function(){
/* @preserve
mat4 calSprite3D(mat4 cameraMTX, mat4 mvMatrix){
mat4 cacheScale = mat4(
mvMatrix[0][0], 0.0, 0.0, 0.0,
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"RedPostEffect_FXAA_Program",t,r)},RedPostEffect_FXAA.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-06-01 19:02:57)');