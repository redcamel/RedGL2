...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"colorProgram",t,r)},RedColorMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedColorMaterial)}(),function(){var e,t,r;RedColorPhongMaterial=function(t,r,n){if(!(this instanceof RedColorPhongMaterial))return new RedColorPhongMaterial(t,r,n);this._color=new Float32Array(4),this.shininess=16,this.specularPower=1,this.alpha=void 0==n?1:n,this.color=r||"#ff0000",this.program=e(t),this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()},t=function(){
/* @preserve
uniform vec4 u_color;
varying vec4 vColor;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"RedPostEffect_FXAA_Program",t,r)},RedPostEffect_FXAA.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-06-01 18:07:44)');