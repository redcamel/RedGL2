...
*/};var i;(RedColorMaterial=function(i,a,o){if(!(this instanceof RedColorMaterial))return new RedColorMaterial(i,a,o);i instanceof RedGL||RedGLUtil.throwFunc("RedColorMaterial : RedGL Instance만 허용.","입력값 : "+i),this.makeProgramList(this,i,"RedColorMaterialProgram",e,t,n),this._color=new Float32Array(4),this.alpha=void 0==o?1:o,this.color=a||"#ff0000",this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBaseMaterial,RedColorMaterial.DEFINE_OBJECT_COLOR={get:function(){return this._colorHex},set:function(e){this._colorHex=e||"#ff2211",i=RedGLUtil.hexToRGB_ZeroToOne.call(this,this._colorHex),this._color[0]=i[0],this._color[1]=i[1],this._color[2]=i[2],this._color[3]=this._alpha}},RedColorMaterial.DEFINE_OBJECT_ALPHA={min:0,max:1,callback:function(e){this._color[3]=this._alpha=e}},Object.defineProperty(RedColorMaterial.prototype,"color",RedColorMaterial.DEFINE_OBJECT_COLOR),RedDefinePropertyInfo.definePrototype("RedColorMaterial","alpha","number",RedColorMaterial.DEFINE_OBJECT_ALPHA),Object.freeze(RedColorMaterial)}(),function(){var e,t,r,n=["useFlatMode"];e=function(){
/* @preserve
// 스키닝
//#REDGL_DEFINE#vertexShareFunc#getSkinMatrix#
// Sprite3D
...
*/};var i={callback:function(){this._searchProgram("RedColorPhongMaterialProgram",n)}};(RedColorPhongMaterial=function(i,a,o){if(!(this instanceof RedColorPhongMaterial))return new RedColorPhongMaterial(i,a,o);i instanceof RedGL||RedGLUtil.throwFunc("RedColorPhongMaterial : RedGL Instance만 허용.","입력값 : "+i),this.makeProgramList(this,i,"RedColorPhongMaterialProgram",e,t,n),this._color=new Float32Array(4),this.shininess=16,this.specularPower=1,this.alpha=void 0==o?1:o,this.useFlatMode=!1,this.color=a||"#ff0000",this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBaseMaterial,Object.defineProperty(RedColorPhongMaterial.prototype,"color",RedColorMaterial.DEFINE_OBJECT_COLOR),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","alpha","number",RedColorMaterial.DEFINE_OBJECT_ALPHA),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","shininess","number",{min:0}),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","specularPower","number",{min:0}),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","useFlatMode","boolean",i),Object.freeze(RedColorPhongMaterial)}(),function(){var e,t,r,n=["normalTexture","specularTexture","displacementTexture","useFlatMode"];e=function(){
/* @preserve
// 스키닝
//#REDGL_DEFINE#vertexShareFunc#getSkinMatrix#
// Sprite3D
...
*/},(RedParticleBitmapMaterial=function(n,i){if(!(this instanceof RedParticleBitmapMaterial))return new RedParticleBitmapMaterial(n,i);n instanceof RedGL||RedGLUtil.throwFunc("RedParticleBitmapMaterial : RedGL Instance만 허용.",n),this.makeProgramList(this,n,"particleBitmapProgram",e,t),this.diffuseTexture=i,this.alpha=1,this.cutOff=.01,this._UUID=RedGL.makeUUID(),r||(this.checkUniformAndProperty(),r=!0)}).prototype=new RedBaseMaterial,RedDefinePropertyInfo.definePrototype("RedParticleBitmapMaterial","diffuseTexture","sampler2D",{essential:!0}),RedDefinePropertyInfo.definePrototype("RedParticleBitmapMaterial","alpha","number",{min:0,max:1}),RedDefinePropertyInfo.definePrototype("RedParticleBitmapMaterial","cutOff","number",{min:0,max:1}),Object.freeze(RedParticleBitmapMaterial)}(),function(){var e,t,r;e=function(){
/* @preserve
void main(void) {
vVertexColor = aVertexColor;
