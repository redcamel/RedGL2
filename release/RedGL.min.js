...
*/};var n={callback:function(){this.searchProgram("colorPhongProgram",r)}};(RedColorPhongMaterial=function(n,i,a,o,s,d){if(!(this instanceof RedColorPhongMaterial))return new RedColorPhongMaterial(n,i,a,o,s,d);n instanceof RedGL||RedGLUtil.throwFunc("RedColorPhongMaterial : RedGL Instance만 허용됩니다.","입력값 : "+n),this._programList=[],this.makeProgramList(this,n,"colorPhongProgram",e,t,r),this._color=new Float32Array(4),this.normalTexture=o,this.specularTexture=s,this.displacementTexture=d,this.normalPower=1,this.shininess=16,this.specularPower=1,this.displacementPower=0,this.displacementFlowSpeedX=0,this.displacementFlowSpeedY=0,Object.defineProperty(this,"color",RedDefinePropertyInfo.color),Object.defineProperty(this,"alpha",RedDefinePropertyInfo.alpha),this.alpha=void 0==a?1:a,this.color=i||"#ff0000",this.normalTexture=o,this.specularTexture=s,this.displacementTexture=d,this._UUID=RedGL.makeUUID(),this.checkUniformAndProperty()}).prototype=new RedBaseMaterial,RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","normalTexture","sampler2D",n),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","specularTexture","sampler2D",n),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","displacementTexture","sampler2D",n),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","normalPower","number",{min:0}),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","shininess","number",{min:0}),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","specularPower","number",{min:0}),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","displacementPower","number",{min:0}),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","displacementFlowSpeedX","number"),RedDefinePropertyInfo.definePrototype("RedColorPhongMaterial","displacementFlowSpeedY","number"),Object.freeze(RedColorPhongMaterial)}(),function(){var e,t,r=["diffuseTexture","normalTexture","specularTexture","displacementTexture"];e=function(){
/* @preserve
varying vec4 vVertexPositionEye4;
...
*/},(RedPostEffect_FXAA=function(r){if(!(this instanceof RedPostEffect_FXAA))return new RedPostEffect_FXAA(r);r instanceof RedGL||RedGLUtil.throwFunc("RedPostEffect_FXAA : RedGL Instance만 허용됩니다.",r),this.frameBuffer=RedFrameBuffer(r),this.diffuseTexture=null,this.program=RedProgram.makeProgram(r,"RedPostEffect_FXAA_Program",e,t),this._UUID=RedGL.makeUUID(),this.updateTexture=function(e){this.diffuseTexture=e},this.checkUniformAndProperty()}).prototype=new RedBaseMaterial,RedPostEffect_FXAA.prototype.bind=RedPostEffectManager.prototype.bind,RedPostEffect_FXAA.prototype.unbind=RedPostEffectManager.prototype.unbind,Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-07-04 17:57:14)');