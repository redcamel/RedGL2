...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"colorProgram",t,r)},RedColorMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedColorMaterial)}(),function(){var e,t,r;RedColorPhongMaterial=function(t,r,n){if(!(this instanceof RedColorPhongMaterial))return new RedColorPhongMaterial(t,r,n);var i,a;this._color=new Float32Array(4),this.shininess=16,this.specularPower=1,Object.defineProperty(this,"color",(a="#ff2211",{get:function(){return a},set:function(e){a=e||"#ff2211",i=RedGLUtil.hexToRGB.call(this,a),this._color[0]=i[0],this._color[1]=i[1],this._color[2]=i[2],this._color[3]=this.alpha}})),Object.defineProperty(this,"alpha",function(){var e="#ff2211";return{get:function(){return e},set:function(t){this._color[3]=e=t}}}()),this.alpha=void 0==n?1:n,this.color=r||"#ff0000",this.program=e(t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
uniform vec4 u_color;
varying vec4 vColor;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"colorPhongProgram",t,r)},RedColorPhongMaterial.prototype=RedBaseMaterial.prototype,Object.freeze(RedColorPhongMaterial)}(),function(){var e,t,r;RedColorPhongTextureMaterial=function(t,r,n,i,a,o){if(!(this instanceof RedColorPhongTextureMaterial))return new RedColorPhongTextureMaterial(t,r,n,i,a,o);var s,u;this._color=new Float32Array(4),this.normalTexture=i,this.specularTexture=a,this.displacementTexture=o,this.shininess=16,this.specularPower=1,this.displacementPower=0,Object.defineProperty(this,"color",(u="#ff2211",{get:function(){return u},set:function(e){u=e||"#ff2211",s=RedGLUtil.hexToRGB.call(this,u),this._color[0]=s[0],this._color[1]=s[1],this._color[2]=s[2],this._color[3]=this.alpha}})),Object.defineProperty(this,"alpha",function(){var e="#ff2211";return{get:function(){return e},set:function(t){this._color[3]=e=t}}}()),this.alpha=void 0==n?1:n,this.color=r||"#ff0000",this.program=e(t),this._UUID=RedGL.makeUUID(),this.checkProperty()},t=function(){
/* @preserve
uniform vec4 u_color;
varying vec4 vColor;
...
*/},t=RedGLUtil.getStrFromComment(t.toString()),r=RedGLUtil.getStrFromComment(r.toString()),e=function(e){return RedProgram(e,"RedPostEffect_FXAA_Program",t,r)},RedPostEffect_FXAA.prototype=RedBaseMaterial.prototype,Object.freeze(RedPostEffect_FXAA)}();console.log('RedGL Release. last update(2018-06-01 16:55:35)');